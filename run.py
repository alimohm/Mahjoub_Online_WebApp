...
def initialize_sovereignty():
    ...
    with app.app_context():
        try:
            ...
            # ابحث عن السطر الذي يحتوي على إنشاء الجداول أو تشغيل التطبيق، وأضف قبله أو بعده:
with app.app_context():
    db.create_all()  # هذا الأمر يجبر قاعدة البيانات على قراءة الحقول الجديدة وزرعها فوراً
