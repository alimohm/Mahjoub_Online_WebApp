...
# تم ضبط الاسم ليكون 'admin' ليتوافق مع url_for('admin.add_supplier') في القوالب
        ...
        try:
            ...
            if 'identity_image' in request.files:
                ...
                if file.filename != '':
                    ...
                    upload_path = 'static/uploads/suppliers'
